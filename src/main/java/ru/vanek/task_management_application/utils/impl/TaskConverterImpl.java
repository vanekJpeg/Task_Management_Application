...
public class TaskConverterImpl implements TaskConverter {
    ...
    public TaskConverterImpl(@Lazy  UserConverter userConverter, @Lazy CommentConverter commentConverter) {
    ...
    public Task convertToTask(TaskRequest taskRequest){
        ...
        task.setExecutor(new User(taskRequest.getExecutorEmail())); //todo добавить остальные параметры в сервисе
        return task;
    }
}
